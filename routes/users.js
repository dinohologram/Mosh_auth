...
router.post('/', async (req, res) => {
    ...
    //Encrypt password
    const salt = bcrypt.genSalt(10) //A salt is used to obfuscate stored data from hackers
    user.password = bcrypt.hash(user.password, salt) //Is hashing a form of encryption? A digital fingerprint.
